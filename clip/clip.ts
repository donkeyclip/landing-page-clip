...
clip.addIncident(
  scale(
    1,
    ".clip-wrapper .item .image-wrapper",
    200,
    "easeInOutCubic",
    "@stagger(0,600)"
  ),
...
clip.addIncident(
  width("460px", ".content-wrapper", 500, "easeInOutCubic"),
  1300
);
clip.addIncident(
  left("-160px", ".clip-wrapper .item", 500, "easeInOutCubic"),
  1300
);
...
clip.addIncident(
  opacity(0, ".blue.cw,.purple.cw,.pink.cw", 300, "easeInOutCubic"),
  11000
);
...
clip.addIncident(
  width("0px", ".content-wrapper", 500, "easeInOutCubic"),
  13100
);
clip.addIncident(
  left("0px", ".clip-wrapper .item", 500, "easeInOutCubic"),
  13100
);

clip.addIncident(
  scale(0, ".clip-wrapper .item .image-wrapper", 300, "easeInOutCubic"),
  13800
);
